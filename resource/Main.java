...
public class Main
{
    ...
    private static List<String> readLines(final String absolutePath) throws IOException {
    ...
    private void writeFile(final List<String> output, final String path) throws IOException {
    ...
    private static String generateCheckDigit(final String enrollmentNumber) throws Exception {
    ...
    private class GerarActionListener implements ActionListener
    {
        @Override
        public void actionPerformed(final ActionEvent e) {
            try {
